 ...
 export const Header = () => {
    return <header className={ `fixed flex justify-between top-0 w-full z-50 p-3 xl:p-4 lg:p-4 md:p-4` }>
        ...
        <div className="flex justify-start items-center gap-2">
            <img src="/assets/images/logo.png" className={ `w-[60px] xl:w-[80px] lg:w-[80px] md:w-[80px] ` }/>
        ...
        <div className="flex justify-end items-center gap-4 xl:gap-8 lg:gap-8 md:gap-8">
            ...
            <div className="rounded-3xl flex items-center bg-purple-600">
                ...
                <button  className="bg-white rounded-3xl px-2 duration-00 xl:px-4 lg:px-4 md:px-4 py-2 -ml-0 xl:-ml-3 lg:-ml-3 md:-ml-3">
                    <img src="/assets/icons/dark.png" className="w-4 h-4"/>
                </button>
            </div>
            <div  className="hidden pr-10 xl:flex lg:flex  items-center gap-6">
                <button className="px-4 py-2 rounded-3xl text-white font-bold">Login</button>
                <span className="h-[28px] w-[2px] bg-white"></span>
                <button className="px-4 py-2 duration-300 rounded-3xl hover:bg-purple-600 bg-white shadow-md font-bold text-black">Sign up</button>
            </div>
